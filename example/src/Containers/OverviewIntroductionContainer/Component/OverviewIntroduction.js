...
class OverviewIntroduction extends React.Component {
  renderIcons = () => (
    <div className='rbc-overview-introduction-icon-group center'>
      <div className='col-lg-3 col-md-3 col-sm-6 col-12'>
        <div>
          <img
            className='rbc-overview-introduction-icon-img'
            src={iconSimple}
          ></img>
        </div>
      ...
      <div className='col-lg-3 col-md-3 col-sm-6 col-12'>
        ...
        <div className='rbc-overview-introduction-icon-span'>
          Effective like a spell
        </div>
      </div>
      <div className='col-lg-3 col-md-3 col-sm-6 col-12'>
        <div>
  ...
  renderFootNotes = () => (
    <div>
      <div>
        - React Blended Components comes under MIT licence © (imohitawasthi) Mohit Awasthi.
      </div>
      <div>
        - You can ask question or raise issues on
        <a
          target='_black'
          href='https://github.com/imohitawasthi/react-blended-components/issues'
        >
